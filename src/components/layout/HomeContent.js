...
const HomeContent = (props) => {
    ...
    useEffect(() => {
        ...
        fetch(
                `https://www.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=9&regionCode=PK&key=AIzaSyAITqyOsCIugGudZsG6FLGM-GOL-RUCknY`
            )
            .then((response) => {
